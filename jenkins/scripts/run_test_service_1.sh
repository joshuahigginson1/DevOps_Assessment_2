...
sudo pytest --junit-xml=service1/src/tests/test_results/junit_results.xml
...
sh -c "pylint-fail-under --fail_under 1 -f parseable src > service1/src/tests/test_results/pylint_report.log"
...
sh -c "pycodestyle src > service1/src/tests/test_results/pep8_report.txt || exit 0"