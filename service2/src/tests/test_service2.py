...
from src.service2 import return_scale_dictionary, return_random_pitch, \
        generate_random_note_pitch, get_note_name, \
...
def test_production_config():
    ...
    assert service2.config['ENV'] == environ.get('FLASK_ENV')
